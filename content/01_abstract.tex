...
Building on the flexibility and scalability of arbitration graphs, the proposed method incorporates runtime verification and structured fallback layers in the decision-making process.
...
\url{github.com/KIT-MRT/arbitration_graphs}
