...
If its preconditions are met, the invocation condition $\invCond$ \todo{translate macros} indicates that the behavior component is applicable in the current situation $\situation$.
