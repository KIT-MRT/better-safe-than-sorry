...
In [?]\todo{Ref to Arbitrators Burger},
...
This section summarizes [?]\todo{Ref diss Pio},
which extends [?]\todo{Ref to Arbitrators Burger} by
...
([?]\todo{Ref Waymo safety stuff} discusses behavior compentencies and operational design domains in detail).
...
See [?]\todo{ref Pios Diss} for other behavior components for automated driving.
