...
Key to reliable operation in fields like autonomous driving as well as mobile and humanoid robotics is ensuring safety and robustness in these processes.
...
Depicted in \cref{fig:entt-pacman} is an open-source implementation\footnote{github.com/indianakernick/EnTT-Pacman} \todo{fix number} of the game that is being used use to demonstrate the proposed method.
